            ...
            <div className="p-4 sm:p-6 overflow-y-auto">
              {activeCategory === 'Personal Computer' ? (
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  <InputGroup label="Department" value={formData.department} onChange={(v) => setFormData({...formData, department: v})} type="select" options={['President Office', 'VP - Office', 'MIS', 'HRD', 'TECHNICAL', 'EHS', 'ENGINEERING', 'MATERIALS', 'MARKETING & SALES', 'FINANCE & ACCOUNTING', 'SECURITY', 'IEM 1', 'IEM 2', 'LCP', 'QC', 'AVP', 'SHIFT MANAGERS', 'CONTRACTOR', ]} />
