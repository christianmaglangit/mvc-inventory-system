...
export default function MVCApp() {
  ...
  return (
    <AuthLayout>
      <LoginPage onSignUpClick={() => setCurrentView('signup')} onForgotClick={() => setCurrentView('forgot')} />
    </AuthLayout>
  );
}

// --- ADDED: Reusable Layout Wrapper for Auth Screens ---
function AuthLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="min-h-screen flex flex-col bg-slate-50 relative font-sans">
      ...
      {/* ADDED FOOTER HERE */}
      <footer className="py-4 text-center text-[10px] font-bold text-slate-400 uppercase tracking-widest relative z-10">
